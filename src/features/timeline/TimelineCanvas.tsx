...
export function TimelineCanvas({
	...
	const handleUpdate = useCallback(
		(id: string, newTime: string) => {
			...
			// This callback is passed from DraggableTimeBlock -> Here -> Parent Screen
...
const styles = StyleSheet.create({
	...
	hourRow: {
		...
		right: 0,
		flexDirection: "row",
		alignItems: "flex-start", // content aligned to top line
	...
	timeLabel: {
		...
		marginTop: -6, // Center vertically on line
		textAlign: "right",
		paddingRight: 8,
	},
	gridLine: {
