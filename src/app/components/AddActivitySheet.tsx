...
export function AddActivitySheet({ visible, onClose, onAdd, initialActivity }: AddActivitySheetProps) {
        ...
        <Modal animationType="slide" transparent={true} visible={visible} onRequestClose={onClose}>
            <View style={styles.overlay}>
                ...
                <View style={styles.sheet}>
                    <Text style={styles.header}>{initialActivity ? 'Edit Activity' : 'Add New Activity'}</Text>
                        ...
                        <View style={styles.priorityRow}>
                            {(['low', 'medium', 'high'] as const).map((p) => (
                                <TouchableOpacity
                                    ...
                                    style={[
                                        styles.priorityBtn,
                                        priority === p && styles[`priorityBtn${p.charAt(0).toUpperCase() + p.slice(1)}` as keyof typeof styles],
                                ...
                                >
                                    <Text style={[
                                        styles.priorityText,
                                        priority === p ? styles.priorityTextActive : styles.priorityTextInactive
                                    ]}>
                    ...
                    <View style={styles.switchRow}>
                        ...
                        <TouchableOpacity
                            ...
                            style={[
                                styles.checkbox,
                                isFlexible && { backgroundColor: colors.primary, borderColor: colors.primary }
                            ]}
                        >
                    ...
                    <TouchableOpacity style={styles.submitBtn} onPress={handleSubmit}>
                        <Text style={styles.submitBtnText}>{initialActivity ? 'Save Changes' : 'Add to Schedule'}</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </Modal>
