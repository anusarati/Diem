...
const ACTIVITY_DATA = [
  ...
  { label: 'Exercise', value: '0h 50m', color: colors.lavenderDark, percent: 15 },
  { label: 'Leisure', value: '1h 30m', color: colors.softPinkDark, percent: 20 },
];

const MAGIC_HOURS = [0.6, 0.8, 1, 1, 0.4, 0.3, 0.2, 0.15, 0.1, 0.05, 0.05, 0.05];

const GOAL_DATA = [
  { id: '1', label: 'Work', targetMinutes: 600, completedMinutes: 165, projectedMinutes: 580, onTrack: true },
  { id: '2', label: 'Study', targetMinutes: 300, completedMinutes: 75, projectedMinutes: 320, onTrack: true },
  { id: '3', label: 'Exercise', targetMinutes: 150, completedMinutes: 50, projectedMinutes: 140, onTrack: false },
];
...
// Behavior heatmap: 7 days × 12 time slots (e.g. 6–22 in ~1.3h blocks). Value 0–1 = intensity.
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          <View style={styles.headerRow}>
            ...
            <View style={styles.navPills}>
              <Pressable onPress={() => onNavigate(ROUTES.HOME)} style={styles.pill}>
              ...
              <Pressable onPress={() => onNavigate(ROUTES.SCHEDULE)} style={styles.pill}>
                <Text style={styles.pillIcon}>📅</Text>
              </Pressable>
            </View>
            ...
            <View style={styles.scoreRow}>
              ...
              <View style={styles.scoreText}>
                ...
                <Text style={styles.scoreSubtitle}>
                  Your productivity score is higher than 80% of your typical Mondays. Keep that
                  spark! 🌟
                </Text>
              </View>
            </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.breakdownCard}>
            {GOAL_DATA.map((g, i) => (
              <GoalTimeRow key={g.id} goal={g} last={i === GOAL_DATA.length - 1} />
            ))}
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.breakdownCard}>
            <BehaviorHeatmap data={HEATMAP_DATA} columnCount={12} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.magicCard}>
            <View style={styles.magicGrid}>
              {MAGIC_HOURS.map((opacity, i) => (
                <View
                  key={i}
                  style={[
                    styles.magicBar,
                    { backgroundColor: `rgba(93, 186, 149, ${opacity})`, borderColor: '#fff' },
                  ]}
                />
              ))}
            </View>
            ...
            <View style={styles.tipRow}>
              ...
              <Text style={styles.tipText}>
                You're a morning lark! Most of your tasks get finished before lunch. 🥐
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.finalTipCard}>
            ...
            <Text style={styles.finalTipBody}>
              You complete tasks{' '}
              <Text style={styles.finalTipBold}>20% more consistently</Text> in the late morning.
              Try scheduling your biggest goals before 11:30 AM tomorrow for that extra feeling of
              success! ✨
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  pillLabel: { fontSize: 10, fontWeight: '700', textTransform: 'uppercase', color: colors.mintDark },
  ...
  scoreCircleSub: { fontSize: 10, fontWeight: '700', color: colors.slate500, textTransform: 'uppercase', marginTop: 2 },
  scoreText: { flex: 1 },
  ...
  breakdownBadgeText: { fontSize: 12, fontWeight: '700', color: colors.mintDark },
  sectionTitle: {
    fontSize: 18,
    fontWeight: '700',
  ...
  magicLabelText: { fontSize: 11, fontWeight: '700', color: colors.slate500, letterSpacing: 1 },
  tipRow: {
    flexDirection: 'row',
  ...
  finalTipBody: { fontSize: 14, color: colors.slate700, fontWeight: '500', lineHeight: 22 },
