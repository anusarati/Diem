...
const INITIAL_ACTIVITIES: TimeBlockProps[] = [
    ...
    // TUESDAY
    { id: '21', title: 'Gym', startTime: '08:00', durationMinutes: 60, type: 'fixed', day: 'Tue', categoryColor: colors.mint },
    { id: '22', title: 'Work Block', startTime: '10:00', durationMinutes: 180, type: 'flexible', day: 'Tue', categoryColor: colors.primary },

    // WEDNESDAY
    { id: '31', title: 'Team Meeting', startTime: '09:00', durationMinutes: 60, type: 'fixed', day: 'Wed', categoryColor: colors.red300 },
    { id: '32', title: 'Design Review', startTime: '14:00', durationMinutes: 90, type: 'fixed', day: 'Wed', categoryColor: colors.lavender },

    // THURSDAY
    { id: '41', title: 'Lunch with Mom', startTime: '12:30', durationMinutes: 90, type: 'fixed', day: 'Thu', categoryColor: colors.peach },

    // FRIDAY
    { id: '51', title: 'Project Demo', startTime: '15:00', durationMinutes: 60, type: 'fixed', day: 'Fri', categoryColor: colors.primary },

    // SATURDAY
    { id: '61', title: 'Hiking', startTime: '09:00', durationMinutes: 240, type: 'flexible', day: 'Sat', categoryColor: colors.mint },

    // OTHER
    { id: '5', title: 'Gym (Legacy)', startTime: '17:00', durationMinutes: 60, type: 'fixed', day: 'Mon', categoryColor: colors.mint }, // Keeping on Mon for demo density
    { id: '6', title: 'Dinner', startTime: '19:00', durationMinutes: 45, type: 'flexible', day: 'Mon', categoryColor: colors.peach },
];
...
export function ScheduleScreen({ onNavigate }: Props) {
    const [activities, setActivities] = useState<TimeBlockProps[]>(INITIAL_ACTIVITIES);
    ...
    const getColorForPriority = (priority: 'high' | 'medium' | 'low') => {
        switch (priority) {
            case 'high': return colors.red400;     // Red for High
            case 'medium': return colors.peachDark; // Orange/Peach for Medium
            case 'low': return colors.mintDark;     // Green for Low
    ...
    const currentDayActivities = activities.filter(a => (a.day || 'Mon') === selectedDay);

    const selectedActivityTitle = activities.find(a => a.id === selectedActivityId)?.title || 'Activity';
        ...
        <SafeAreaView style={styles.safe}>
            <View style={styles.mainContainer}>
                ...
                <View style={styles.nav}>
                    <Pressable onPress={() => onNavigate(ROUTES.HOME)} style={styles.navBtn}>
                        <Text style={styles.navIcon}>🏠</Text>
                    </Pressable>
                    <Pressable onPress={() => { }} style={styles.navBtn}>
                        <Text style={[styles.navIcon, styles.navIconActive]}>📅</Text>
                    </Pressable>
                    <Pressable onPress={() => onNavigate(ROUTES.ANALYSIS)} style={styles.navBtn}>
                        <Text style={styles.navIcon}>📊</Text>
                    </Pressable>
                    <Pressable onPress={() => { }} style={styles.navBtn}>
                        <Text style={styles.navIcon}>👤</Text>
