...
export function HomeScreen({ onNavigate }: Props) {
  ...
  const focusPercent = totalCount ? Math.round((completedCount / totalCount) * 100) : 0;
    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
          ...
          <View style={styles.focusCard}>
            ...
            <View style={styles.focusText}>
              ...
              <Text style={styles.focusSubtitle}>
                You've completed {completedCount} of {totalCount} tasks. Almost there!
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.nav}>
          ...
          <Pressable onPress={() => onNavigate(ROUTES.SCHEDULE)} style={styles.navBtn}>
...
const styles = StyleSheet.create({
  ...
  focusSubtitle: { fontSize: 12, fontWeight: '300', color: colors.slate400, marginTop: 4 },
  scroll: { flex: 1 },
  ...
  cloudDeco: { alignItems: 'center', paddingVertical: spacing.section, opacity: 0.2 },
